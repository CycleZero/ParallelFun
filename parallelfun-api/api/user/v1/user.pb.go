...
const file_api_user_v1_user_proto_rawDesc = "" +
	...
	"\x04User\x129\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x15.user.v1.GetUserReplyB Z\x1eparallelfun-api/api/user/v1;v1b\x06proto3"
...
var file_api_user_v1_user_proto_depIdxs = []int32{
	...
	1, // 1: user.v1.User.GetUser:output_type -> user.v1.GetUserReply
